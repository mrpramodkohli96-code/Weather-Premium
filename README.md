...
•
Open-Meteo (Default): Reliable local data.
•
...
•
7-Day Forecast: Expands to show Sunrise/Sunset times, Total Rainfall, and a visual Rainbow UV Index Bar.
•
Rain Expectancy: Get today's exact probability, estimated volume, and smart "Carry an umbrella" reminders.
•
...
•
GPS Ready: Precise "My Location" detection with a single tap.
•
Adaptive Design: The app’s background aura changes color based on temperature—from Scorching Red to Subzero Purple.
🛠️ Technology Stack
•
Language: Kotlin
•
...
•
Data Source: Open-Meteo API integration
🏁 Version 1.0
